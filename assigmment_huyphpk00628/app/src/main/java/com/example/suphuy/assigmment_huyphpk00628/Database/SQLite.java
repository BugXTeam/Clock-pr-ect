...
public class SQLite extends SQLiteOpenHelper {
    ...
    //11 biến tạo bảng personal (huyphpk0062 8@fpt.edu.vn)
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        // String câu truy vấn tạo bảng personal(huyphpk00628@fpt.edu.vn)
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP IF EXISTS " + Table_ThuChi);
        ...
        sqLiteDatabase.execSQL("DROP IF EXISTS " + Table_Personal);

        sqLiteDatabase.execSQL("DROP IF EXISTS " + Table_TKDN);
    }
    ...
    public ArrayList<Chi> GetAllChi(Chi.Type loai, Chi.Time tg) {
        ...
        Log.v("tieude", dateTimenow.getDayOfMonth() + "huy");
        if (cursor.moveToFirst()) {
            do {
                Chi chi = new Chi();
                    ...
                    if (dateTimenow.getThu1() == 1) {
                        ...
                        if (
                                ...
                                &&
                                        dateTime.getMonthOfYear() == dateTimenow.getMonthOfYear()
                                && dateTime.getYear() == dateTimenow.getYear() ){
                            Log.e("huy12 dfdfsd", chi.getStringNgayChi());
                            if (loai ==  Chi.Type.TatCa)
                                listChi.add(chi);
                            else if (loai.getIntValue() ==  chi.getMaLoaiMuc()) {
                                listChi.add(chi);
    ...
    public int updateChi(Chi chi) {
        ...
        values.put(ThuChi_SoTien, chi.getSoTien());
        values.put(ThuChi_GhiChu, chi.getGhiChu());
        return db.update(Table_ThuChi, values, ThuChi_ID + " = ?",
...
//12
    ...
    // function  xóa 1 bảng Personal (huyphpk00628@fpt.edu.vn)
    ...
    // function  lấy tất cả tên bảng Personal (huyphpk00628@fpt.edu.vn)
    ...
    // function lấy danh sách id Personal  (huyphpk00628@fpt.edu.vn)
