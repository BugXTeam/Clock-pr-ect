...
//
            ...
            case R.id.btnBack:{
             ...
             case R.id.lnOther:{
                 ...
                 if(lnOtherValue.getVisibility()==View.GONE) {
                     ...
                     text.setText(txtOtherValue.getText().toString()+" "+getString(R.string.Months));
                     fragmentControlThuChi.startAnimation(animationthoat);
                     fragmentControlThuChi.setVisibility(View.GONE);
                 }
    ...
    public void setchecked(String t) {
        ...
        if(   t.equals(getString(R.string.SavingTermTypeThreeMonth))){
                imgThreeMonth.setVisibility(View.VISIBLE);
            }else
        if(   t.equals(getString(R.string.SavingTermTypeSixMonth))){
                imgSixMonth.setVisibility(View.VISIBLE);
            }else
        if(   t.equals(getString(R.string.SavingTermTypeTwelveMonth))){
                imgTwelveMonth.setVisibility(View.VISIBLE);
            }else
        if(   t.equals(getString(R.string.ln24Month))){
    ...
    public void setunchecked(String t) {
        ...
        if(   t.equals(getString(R.string.SavingTermTypeOther))){
