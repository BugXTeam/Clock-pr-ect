package com.example.suphuy.assigmment_huyphpk00628.Fragment.ThuChi;
...
import com.example.suphuy.assigmment_huyphpk00628.Activity.ThuChiActivity;
...
import com.example.suphuy.assigmment_huyphpk00628.Database.before;
import com.example.suphuy.assigmment_huyphpk00628.Fragment.Public.Fragment_Category;
...
import com.example.suphuy.assigmment_huyphpk00628.Fragment.Public.Fragment_Personal;
import com.example.suphuy.assigmment_huyphpk00628.Fragment.Public.Fragment_Tick_Account;
...
public class Fragment_ThuChi extends Fragment implements View.OnClickListener, DateTimePicker.OnDateTimeSetListener {
    ...
    FrameLayout fragmentControlThuChi, fragmentControlThuChiRight,
            fragmenttControlThuChiInRight;
    LinearLayout lnSelectDate, lnSelectCategory,huy12, lnSelectAccount, lnDescription,
            lnExpenseFor;
    LinearLayout MainThuChi;
    Animation animationthoat, animation, animationright_out, animationleft_in;
    TextView txteditMoney, txtExpenseType, txtDescription, txtAccountName, txtDate,
            txtExpenseFor, txtLenderTitle, txtLender, AccountFrom, textViewExpenseFor;
        ...
        radioButtonChi.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    ...
                    spinnerMuc.setVisibility(View.GONE);
                    ThuChiActivity.textSwitcher.setText("Chi");
                    ...
                    ThuChiActivity.textSwitcher.setText(getString(R.string.TextThu));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnSelectCategory: {
                if (radioButtonChi.isChecked() == true) {
                    fragmentControlThuChi.setVisibility(View.VISIBLE);
                    fragmentManager
                            .beginTransaction()
                            .replace(fragmentControlThuChi.getId(),
